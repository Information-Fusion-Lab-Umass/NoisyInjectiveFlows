...
if(__name__ == '__main__'):
    ...
    with tf.Session() as sess:
        ...
        for name in tqdm(args.names):
            ...
            stats_path = meta['stats'].strip('FID/')
            ...
            for i, setting in enumerate(tqdm(all_settings)):
                ...
                samples_path = setting['path'].strip('FID/')
                paths = (samples_path, stats_path)
                ...
                # fid_score = calculate_fid_given_paths(paths, None, low_profile=True)
